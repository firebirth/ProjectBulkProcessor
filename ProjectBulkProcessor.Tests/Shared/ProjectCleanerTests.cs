    ...
    public class ProjectCleanerTests
    {
        ...
        public static IEnumerable<object[]> TransitiveReferencesTestData
        {
            get
            {
                ...
                var childNestedProject2Actual = new ProjectModel(GetFileInfo("childProject2", mockFileSystemNested), new[] { new ProjectReferenceModel("../childProject1/childProject1.csproj"), new ProjectReferenceModel("../parentProject/parentProject.csproj") }.ToImmutableList(), new[] { new PackageDependencyModel("testPackage", "1") }.ToImmutableList());
